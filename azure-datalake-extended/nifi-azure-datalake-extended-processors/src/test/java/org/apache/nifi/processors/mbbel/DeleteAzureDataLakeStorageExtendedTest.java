...
public class DeleteAzureDataLakeStorageExtendedTest {

    @Test
    public void testInputRequired() {
        final InputRequirement requirement = DeleteAzureDataLakeStorageExtended.class.getAnnotation(InputRequirement.class);
        assertNotNull(requirement);
        assertEquals(Requirement.INPUT_REQUIRED, requirement.value());
    }

    @Test
    public void testPropertiesMatchStockDeleteAzureDataLakeStorage() {
        final List<PropertyDescriptor> base = new DeleteAzureDataLakeStorage().getPropertyDescriptors();
        final List<PropertyDescriptor> extended = new DeleteAzureDataLakeStorageExtended().getPropertyDescriptors();
    ...
    public void testSeeAlsoIncludesExtendedCredentialsService() {
        final SeeAlso seeAlso = DeleteAzureDataLakeStorageExtended.class.getAnnotation(SeeAlso.class);
