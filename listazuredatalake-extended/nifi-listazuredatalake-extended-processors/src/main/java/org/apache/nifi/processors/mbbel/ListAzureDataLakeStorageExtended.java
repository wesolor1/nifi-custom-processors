...
@SeeAlso({ListAzureDataLakeStorage.class})
@CapabilityDescription("Lists directory in an Azure Data Lake Storage Gen 2 filesystem. "
        ...
        + "evaluate Expression Language on the Filesystem Name and Directory Name properties and are copied onto every emitted listing "
