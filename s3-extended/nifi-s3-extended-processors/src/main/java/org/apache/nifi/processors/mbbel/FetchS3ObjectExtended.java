...
/**
 * Drop-in variant of {@link FetchS3Object} for use with {@link ListS3Extended} and
...
public class FetchS3ObjectExtended extends FetchS3Object {
    ...
    /**
     * Stock FetchS3Object calls this with {@code flowFile.getAttributes()} before talking to S3. Capture those attributes
    ...
    private final class FlowFileAwareCredentialsProvider implements AwsCredentialsProvider {
        ...
        public AwsCredentials resolveCredentials() {
            ...
            try {
                return FetchS3ObjectExtended.super.getCredentialsProvider(context).resolveCredentials();
            } finally {
                AWSCredentialsProviderControllerServiceExtended.clearEvaluationAttributes();
            }
        }
